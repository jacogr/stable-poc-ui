...
function _ownExposure(api) {
  return (0, _util.memo)((accountId, era, withActive) => {
...
function ownExposure(api) {
  return (0, _util.memo)((accountId, era) => api.derive.staking._ownExposure(accountId, era, true));
}

function _ownExposures(api) {
  return (0, _util.memo)((accountId, eras, withActive) => eras.length ? (0, _rxjs.combineLatest)(eras.map(era => api.derive.staking._ownExposure(accountId, era, withActive))) : (0, _rxjs.of)([]));
}

function ownExposures(api) {
  return (0, _util.memo)((accountId, withActive = false) => {
