...
class Settings {
  constructor() {
    ...
    (0, _classPrivateFieldLooseBase2.default)(this, _apiUrl)[_apiUrl] = typeof settings.apiUrl === 'string' && settings.apiUrl || process.env.WS_URL || _defaults.ENDPOINT_DEFAULT;
