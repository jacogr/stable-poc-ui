...
const VERIFIERS = [['ed25519', _verify.default], ['sr25519', _verify2.default], ['ecdsa', _verify3.default]];
...
function verifyMultisig(result, message, signature, publicKey) {
  ...
  try {
    result.isValid = {
      ecdsa: () => (0, _verify3.default)(message, signature.subarray(1), publicKey),
